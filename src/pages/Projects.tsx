...
export default function Projects() {
  return (
<div className='flex flex-col mt-10 sm:h-auto h-screen mb-10'>
      <div className='text-4xl font-bold mt-20 ml-0 sm:ml-12 mr-5 sm:mr-0 flex justify-center sm:justify-start'>Projects</div>
